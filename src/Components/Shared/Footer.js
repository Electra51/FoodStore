...
const Footer = () => {
    return (
        <footer className='px-2 divide-y  text-gray-800 bg-black' >
        <div className='container flex flex-col items-center content-center py-5 mx-auto space-y-8 lg:flex-row lg:space-y-0'>
          ...
          <Link
            ...
            className='inline-flex items-center'
                  >
                        ...
                        <p className='pl-3 text-xl font-bold'>PickFood</p>
          </Link>
          </div>
          <div className='grid grid-cols-2 items-center text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4'>
            ...
            <div className='space-y-3'>
              <h3 className='tracking-wide uppercase text-gray-500'>SERVICES</h3>
              <ul className='space-y-1'>
                <li>
                  <Link >Privacy</Link>
                </li>
